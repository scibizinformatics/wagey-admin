      ...
      <q-card-section class="modal-content">
        <div class="detail-sections">
          <div class="detail-section">
            ...
            <div v-if="request?.reason" class="info-content" style="margin-top: 10px">
              <div class="info-label">Reason:</div>
              <div class="info-text">{{ request.reason }}</div>
            </div>
          </div>
          <div v-if="request?.status === 'pending'" class="detail-section">
            ...
            <div class="form-grid">
              ...
              <q-input
                outlined
                :model-value="approvalData.approved_hours"
                @update:model-value="$emit('update:approvalData', { ...approvalData, approved_hours: $event })"
              ...
              <q-select
                outlined
                :model-value="approvalData.category"
                @update:model-value="$emit('update:approvalData', { ...approvalData, category: $event })"
              ...
              <q-input
                outlined
                :model-value="approvalData.reason"
                @update:model-value="$emit('update:approvalData', { ...approvalData, reason: $event })"
                label="Remarks"
                type="textarea"
                rows="3"
                class="col-span-2"
